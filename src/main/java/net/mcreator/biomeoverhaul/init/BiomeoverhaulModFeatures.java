...
import net.mcreator.biomeoverhaul.world.features.ores.MudFeature;
...
public class BiomeoverhaulModFeatures {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, BiomeoverhaulMod.MODID);
